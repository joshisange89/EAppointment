...
<html>
	...
	<body>
		<div id="wrapper">		
			...
			<ul>
				<li><a href="../Appointments/ViewAppointments.jsp?email=<%=(String)request.getAttribute("email")%>&type=<%=(String)request.getAttribute("type")%>"> My Appointments </a></li>
				<li><a href="../Appointments/ScheduleAppointment.jsp?email=<%=(String)request.getAttribute("email")%>"> Schedule Appointment</a></li>
				<li><a href="../Profile/ChangePassword.jsp?email=<%=(String)request.getAttribute("email")%>">Change Password</a></li>
