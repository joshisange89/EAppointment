...
<html>
	...
	<body>
		<div id="wrapper">		
			...
			<div id="content" class="background">
				...
				<div id="tabs" class="transbox">
					<ul>
						<li><a  href='../Appointments/ViewAppointmentFacult.jsp?email=<%=(String)request.getAttribute("email")%>&type=<%=(String)request.getAttribute("type")%>'><span>My Appointments</span></a></li>
		...
		<script src="../jquery/datepicker/jquery/jquery.js" type="text/javascript"></script>
		<!-- Jquery -->
